        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="nomor-antrian" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="panggilan-antrian" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="panggilan-display" class="btn btn-success rounded-pill px-4 py-2" target="_blank">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="#" target="_blank" class="text-danger text-decoration-none">Dhe Rinaldi SIRS RSUD Lawang</a>. All rights reserved.
      </div>
    </div>
  </footer>

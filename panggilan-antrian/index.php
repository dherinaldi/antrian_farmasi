...
<body class="d-flex flex-column h-100">
    ...
    $(document).ready(function() {
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        // jika data "status = 0"
                            ...
                            var btn =
                                "<button class=\"btn btn-info btn-sm rounded-circle cetak\">Print</button><button class=\"btn btn-success btn-sm rounded-circle panggil\"><i class=\"bi-mic-fill\"></i></button>";
                        }
                        // jika data "status = 1"
                        else if (data["status"] === "1") {
                            // tampilkan button ulangi panggilan
                            var btn =
                                "<button class=\"btn btn-secondary btn-sm rounded-circle cetak\">Print</button><button class=\"btn btn-secondary btn-sm rounded-circle panggil\"><i class=\"bi-mic-fill\"></i></button>";
                        };
        ...
        $('#tabel-antrian tbody ').on('click', 'button.panggil', function() {
